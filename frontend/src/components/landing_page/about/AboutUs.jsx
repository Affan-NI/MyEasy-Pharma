          ...
          >
            <div>
              ...
              <div className="text-gray-700 leading-relaxed space-y-4">
                <div
                  className={`lg:block ${isExpanded ? "block" : "hidden"} lg:space-y-4`}
                >
                  <p>
                    Startups like{" "}
                    <span className="font-semibold text-teal-700">
                      MyEasy Pharma Pvt Ltd{" "}
                    </span>
                    are spearheading Pharma 4.0 revolutions in diabetic care
                    management with AI-powered predictive analytics, IoT-enabled
                    glucose tracking, blockchain-secured supply chains, and edge
                    computing for instant anomaly detection.
                  </p>

                  <p>
                    Smart sensors in insulin delivery systems help pre-empt
                    hypoglycemic events, reducing hospitalization risk while
                    improving adherence through personalized digital
                    therapeutics tailored for Indian patients.
                  </p>

                  <p>
                    Automated manufacturing and data-driven formulations ensure
                    precision, affordability, and better outcomes in high-burden
                    regions.
                  </p>

                  <p>
                    Sustainability remains core — with optimized facilities,
                    recyclable packaging, and outcome forecasting data lakes
                    that empower clinicians with real-time insights.
                  </p>

                  <p>
                    This ecosystem bridges urban-rural care gaps, improves
                    glycemic control, and transforms diabetes from a chronic
                    burden into a manageable, tech-enabled lifestyle condition.
                  </p>
                </div>
          ...
          <div className="flex flex-col gap-8">
            <div className="bg-white rounded-2xl border shadow-sm p-6 md:p-8">
              <p className="text-gray-700 leading-relaxed">
                ...
                is a legally compliant, Startup India and MSME registered
                company incorporated in November 2024. We are building an
                AI-native healthcare platform bridging advanced technology with
                accessible, outcome-driven care.
              </p>
            ...
            <div>
              ...
              <div className="grid gap-4">
                {incubations.map((i, idx) => (
                  ...
                  >
                    <div
                      className={`text-sm mb-2 ${i.highlight ? "text-teal-100" : "text-gray-500"}`}
                    >
                      {i.type}
                    </div>
                    ...
                    {i.highlight && (
                      <div className="text-sm mt-2 text-teal-100">
                        Country's 1st health organisation with dedicated
                        incubator
                      </div>
                    )}
                  </div>
