        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="max-w-xl">
              <h1 className="text-3xl font-bold text-[#F05A28] mb-1">
                Pharma 4.0
              </h1>
              ...
              <p
                className={`
                  ...
                  ${readMore ? "max-h-[1000px]" : "max-h-[108px] overflow-hidden"}
                `}
              >
              ...
              <button
                ...
                className="mt-3 text-[#F05A28] font-semibold hover:underline"
              >
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="bg-white rounded-2xl shadow-lg px-6 py-4 w-56 text-center">
                <div className="w-12 h-12 bg-[#F05A28]/10 rounded-xl flex items-center justify-center mx-auto mb-3">
                  <Users className="w-6 h-6 text-[#F05A28]" />
                </div>
                <h3 className="text-sm font-semibold">Unified Network</h3>
              ...
              <div className="bg-white rounded-2xl shadow-lg px-6 py-4 w-56 text-center">
                <div className="w-12 h-12 bg-[#F05A28]/10 rounded-xl flex items-center justify-center mx-auto mb-3">
                  <Database className="w-6 h-6 text-[#F05A28]" />
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg px-6 py-4 w-56 text-center">
                <div className="w-12 h-12 bg-[#F05A28]/10 rounded-xl flex items-center justify-center mx-auto mb-3">
                  <Activity className="w-6 h-6 text-[#F05A28]" />
                </div>
                <h3 className="text-sm font-semibold">Smart Care</h3>
                <p className="text-xs text-gray-600">
