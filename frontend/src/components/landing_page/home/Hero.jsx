...
export function Hero() {
  ...
  "
      ...
      `}
              >
                We are building an AI-native digital platform that connects
                doctors, hospitals, pharmaceutical companies, researchers, and
                patients into one unified, intelligent ecosystem. Our mission is
                to transform fragmented healthcare systems into a smart,
                collaborative network powered by data and innovation. We turn
                raw healthcare data into actionable intelligence, empowering
                clinicians to make faster decisions, researchers to generate
                real-world insights, pharma companies to innovate responsibly,
                and patients to receive personalized, continuous care. By
                integrating Artificial Intelligence, real-world data, cloud
                infrastructure, interoperability, and predictive analytics, we
                enable outcome-driven healthcare at scale.
              </p>
