    ...
    <section className="py-10 bg-white">
        <div className="container mx-auto px-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              { icon: Code, title: "Technologists", desc: "Building scalable AI systems", color: "teal" },
              { icon: Microscope, title: "Clinicians", desc: "Ensuring clinical validity", color: "teal" },
              { icon: BarChart, title: "Researchers", desc: "Advancing healthcare science", color: "teal" },
          ...
          {/* Key Message */}
          <div className="bg-teal-800 rounded-2xl p-8 md:p-10 text-white mb-12">
  <div className="flex items-start gap-4">
    ...
    <div>
      ...
      <p className="text-lg leading-relaxed opacity-95">
        Driven by the founder's <span className="font-semibold">tireless efforts, unwavering resolve, 
